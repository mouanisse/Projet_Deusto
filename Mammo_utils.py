...
class Mammographie:
    ...
    def model(self):
        ...
        model.add(keras.layers.Conv2D(160, (3, 3), activation='relu', activity_regularizer=keras.regularizers.l1(0.1)))
        model.add(keras.layers.BatchNormalization())
        model.add(keras.layers.MaxPooling2D(2, 2))
        

        model.add(keras.layers.Conv2D(320, (3, 3), activation='relu', activity_regularizer=keras.regularizers.l1(0.1)))
        model.add(keras.layers.BatchNormalization())
        model.add(keras.layers.MaxPooling2D(2, 2))
